...
1)Provider: A wrapper that will make the central store to all component tree

2)Store: A central location that holds state

3)Reducer: A component that is only allow to change the state,there can be many reducer e.g customReducer,itemReducer,studentReducer etc.

4)Action: A simple JS objectthat inform Reducer what part of state need to be changed and what type of change to carry out.
